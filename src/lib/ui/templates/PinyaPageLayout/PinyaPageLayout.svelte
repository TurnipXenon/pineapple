	...
	<header class={`bg-surface-100-900 shadow-md ${extraClass}`}>
		...
		{:else}
			<button
				...
				title="Home"
			>
				<img aria-hidden="true" alt="" class="ares-logo" src={AresLogo} />
			</button>
		...
		{:else}
			<div id="header-action-wrapper">
				...
				<PinyaButton
					...
					colorScheme={isMounted && enableUniversalOverlay && appState.allowDialog !== false
