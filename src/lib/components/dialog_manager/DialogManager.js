...
import { DialogState } from "$lib/types/pineapple_fiber/DialogState";
...
import AresBlushing from "$lib/assets/characters/ares/ares_blushing.webp";
import AresDisappointed from "$lib/assets/characters/ares/ares_disappointed.webp";
import AresLetsGo from "$lib/assets/characters/ares/ares_lets_go.webp";
import AresMad from "$lib/assets/characters/ares/ares_mad.webp";
import AresNeutral from "$lib/assets/characters/ares/ares_neutral.webp";
import AresSlightlyMad from "$lib/assets/characters/ares/ares_slightly_mad.webp";
import AresSurprised from "$lib/assets/characters/ares/ares_surprised.webp";
import AresYay from "$lib/assets/characters/ares/ares_yay.webp";
import { defaultDialogMessage, dialogVariableStore, enableDialogueOverlay, updateRate } from "$lib/components/dialog_manager/DialogManagerStore";
import { DialogProcessor } from "$lib/components/dialog_manager/DialogProcessor";
