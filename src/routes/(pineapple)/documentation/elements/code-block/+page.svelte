...
/>`;
	...
	const propsCode =
		(propSources["/src/lib/ui/elements/CodeBlock/CodeBlockProps.ts"] as string) ?? "";
...
<ul>
	<li>
		Syntax highlighting powered by Shiki. See <TextLink href="https://shiki.style/"
			>https://shiki.style/</TextLink
		> and
		<TextLink href="https://www.skeleton.dev/docs/integrations/code-block/svelte/"
			>https://www.skeleton.dev/docs/integrations/code-block/svelte/</TextLink
		>
	</li>
...
<p>
	<b
		>transformerNotationDiff (see <TextLink
			href="https://shiki.style/packages/transformers#transformernotationdiff"
			>https://shiki.style/packages/transformers#transformernotationdiff</TextLink
		>):</b
	>
</p>
<CodeBlock
...
<ul>
	<li>
		If styling is broken, there's most likely something wrong with the code props. Common issues
		include <b>having an unopened comment section like <code>/*[!code ++]</code></b>
	</li>
	<li>
		We had Tailwind at the time this was made but there's too much effort to remove it completely.
	</li>
...
<p>
	...
	<TextLink
		target="_blank"
		href="https://github.com/TurnipXenon/pineapple/blob/2802a54370bd643004f0b4d5d40431b476e1b5f2/src/lib/ui/elements/CodeBlock/CodeBlock.svelte"
		>https://github.com/TurnipXenon/pineapple/blob/2802a54370bd643004f0b4d5d40431b476e1b5f2/src/lib/ui/elements/CodeBlock/CodeBlock.svelte</TextLink
	>
</p>
<p>
	Example code:
	<TextLink
		target="_blank"
		href="https://github.com/TurnipXenon/pineapple/blob/70a3193488d345e609b9151f27f17511650bb12f/src/lib/ui/templates/SeaweedLayout/SeaweedLayout.svelte#L248"
		>https://github.com/TurnipXenon/pineapple/blob/70a3193488d345e609b9151f27f17511650bb12f/src/lib/ui/templates/SeaweedLayout/SeaweedLayout.svelte#L248</TextLink
	>
</p>
