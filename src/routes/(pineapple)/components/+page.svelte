	...
	<PinyaCard widthClass="max-w-2xl" flexClass="flex flex-col gap-4">
		...
		<PinyaAccordion openItems={openAccordionIds} multiple={allowMultipleOpenAccordion}>
			<PinyaAccordionItem pinyaValue="club">
				...
				<!-- Panel -->
				{#snippet panel()}Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sit esse nisi
					eligendi fuga! Quas nisi repellat adipisci animi repellendus incidunt laborum sunt qui
					nesciunt, ducimus saepe sapiente sed ut labore. Lorem ipsum dolor, sit amet consectetur
					adipisicing elit. Sit esse nisi eligendi fuga! Quas nisi repellat adipisci animi
					repellendus incidunt laborum sunt qui nesciunt, ducimus saepe sapiente sed ut labore.{/snippet}
			</PinyaAccordionItem>
		...
		<PinyaAnchorButton href="/test"
			><span class="external-link">Go to /test (external test)</span></PinyaAnchorButton
		>
	</PinyaCard>
	...
	<PinyaCard widthClass="max-w-2xl">
		<div class="card-container">
			...
			<p>
				...
				break up the daily monotony of watering crops. In the games, players have the option of
				getting married, raising livestock and poultry animals, catching fish, and attending
				festivals to impress the local villagers.
			</p>

			<p>
				Harvest Moon (Bokujou Monogatari) was first published in Japan in 1996 by Pack In Video; the
				company, after several mergers, is currently known as <a href="https://www.marv.jp/"
					>Marvelous</a
				>. In North America, the game was published by Natsume, Inc. in 1998. Natsume handled the
				English version up until Harvest Moon: A New Beginning. In 2014, Marvelous annnounced that
				it will be using its North American localization branch, XSeed Games (Marvelous USA), to
				translate Bokujou Monogatari into English under its own title, Story of Seasons. Natsume
				still owns the Harvest Moon trademark and will continue to develop the series independently
				of Marvelous.
			</p>
